  ...
  return (
    ...
    >
      <div className="sm: ml-2 lg:ml-12 mt-5">
        ...
        <div className="grid sm: grid-cols-1 lg:grid-cols-2 sm: max-w-screen lg:w-[242.5%] h-120 gap-10 mt-18 ">
          <motion.div
            whileHover={{
              scale: 1.025,
