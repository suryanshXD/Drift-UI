...
import DragableButton from "@/registry/new-york/Dragable-Button/Dragable-Button";
    ...
    <>
      ...
      >
        ...
        <div className="text-gray-600  mt-3 sm: text-[12.5px] lg:text-[15.5px] font-stretch-200%">
          An interactive button you can drag around, adding a fun, hands-on feel
          to your experience.
        </div>
        <div className="mt-3">
              ...
              <div className="flex min-w-max justify-between items-center text-white sm: text-[12px] lg:text-[14.5px] pr-7">
                <div className="flex">
                  ...
                  <span className="text-[#9ECBFF]">
                    https://drift-ui-swart.vercel.app/r/Dragable-Button.json
                  </span>
                </div>
                <motion.div
                  whileTap={{ scale: 0.9 }}
        ...
        <div
          ref={propsRef}
          className="flex sm: w-[98.5%] lg:w-full sm: h-8 lg:h-10 bg-gray-100 border-r border-l border-t border-gray-300 sm: mt-3 lg:mt-6 font-medium"
        >
