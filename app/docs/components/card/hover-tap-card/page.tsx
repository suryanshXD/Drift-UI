    ...
    <>
      ...
      >
        ...
        <div className="text-gray-600  mt-3 sm: text-[12.5px] lg:text-[15.5px] font-stretch-200%">
          A playful hover-and-tap image effect that adds depth and
          motion—perfect for making visuals feel alive and interactive.
        </div>
        <div className="mt-3">
              ...
              <div className="flex min-w-max justify-between items-center text-white sm: text-[12px] lg:text-[14.5px] pr-7">
                <div className="flex">
                  ...
                  <span className="text-[#9ECBFF]">
                    https://drift-ui-swart.vercel.app/r/Hover-Tap-Image.json
                  </span>
                </div>
                <motion.div
                  whileTap={{ scale: 0.9 }}
