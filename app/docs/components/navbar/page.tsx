    ...
    <>
      ...
      >
        <div className="flex items-center gap-0.5 text-gray-600 sm: mt-5  lg:mt-8 sm: text-[12px] lg:text-[14px] ">
          ...
          <div>Components</div>
          <ChevronRight />
          <Link href={"/docs/components/navbar"} className="cursor-pointer">
            Navbar
          </Link>
        </div>
        <div
        ...
        <div className="text-gray-600  mt-3 sm: text-[12.5px] lg:text-[15.5px] font-stretch-200%">
          A modern, animated navbar where each link glides into a sleek dark
          highlight on hover—bringing responsive flair and smooth motion to your
          navigation.
        </div>
        <div className="mt-3">
              ...
              <div className="flex min-w-max justify-between items-center text-white sm: text-[12px] lg:text-[14.5px] pr-7">
                <div className="flex">
                  ...
                  <span className="text-[#9ECBFF]">
                    https://drift-ui-swart.vercel.app/r/Navbar.json
                  </span>
                </div>
                <motion.div
                  whileTap={{ scale: 0.9 }}
        ...
        <div className="sm: mt-7 lg:mt-14 sm: w-[98%] lg:w-full bg-blue-50 border border-blue-300 rounded-md">
          <div className="text-gray-600 sm: px-1.5 lg:px-3 sm: py-1.5 lg:py-2 flex items-center">
            ...
            <div className="flex flex-col sm: gap-1 lg:gap-3 sm: ml-3.5 lg:ml-5 sm: text-[9px] lg:text-[14px]">
              <div>
                The navbar component require the following inputs in the form of
                an array. The array have two constraints - name and herf.
                Example -
              </div>
              <div>
                <div>
        ...
        <div className="flex w-full sm: h-8 lg:h-10 mb-12 font-extralight bg-neutral-50 border-b sm: border-gray-200 lg:border-white">
          ...
          <div className="flex flex-col w-[60%] text-gray-800">
            <div className=" sm: pl-0 lg:pl-3 sm: py-0.1 lg:py-1.5 sm: text-[10px] lg:text-[15px]">
              The array of content which you want to show on the navbar
            </div>
          </div>
        </div>
