    ...
    <>
      ...
      >
        <div className="flex items-center gap-0.5 text-gray-600 sm: mt-5  lg:mt-8 sm: text-[12px] lg:text-[14px] ">
          ...
          <div>Components</div>
          <ChevronRight />
          <Link href={"/docs/components/marquee"} className="cursor-pointer">
            Marquee
          </Link>
        </div>
        <div
        ...
        <div className="text-gray-600  mt-3 sm: text-[12.5px] lg:text-[15.5px] font-stretch-200%">
          A responsive, continuously scrolling marquee component built with
          Framer Motion to display a seamless loop of items horizontally.
        </div>
        <div className="mt-3">
              ...
              <div className="flex min-w-max justify-between items-center text-white sm: text-[12px] lg:text-[14.5px] pr-7">
                <div className="flex">
                  ...
                  <span className="text-[#9ECBFF]">
                    https://drift-ui-swart.vercel.app/r/Marquee.json
                  </span>
                </div>
                <motion.div
                  whileTap={{ scale: 0.9 }}
