...
import ThreeCardScroll from "@/registry/new-york/Three-Card-ScrollUp/Three-Card-ScrollUp";
    ...
    <>
      ...
      >
        ...
        <div className="text-gray-600  mt-3 sm: text-[12.5px] lg:text-[15.5px] font-stretch-200%">
          A sleek, scroll-activated trio of floating cards that gracefully slide
          outward, adding a dynamic flair to your UI with layered motion magic.
        </div>
        <div className="mt-3">
              ...
              <div className="flex min-w-max justify-between items-center text-white sm: text-[12px] lg:text-[14.5px] pr-7">
                <div className="flex">
                  ...
                  <span className="text-[#9ECBFF]">
                    https://drift-ui-swart.vercel.app/r/Three-Card-ScrollUp.json
                  </span>
                </div>
                <motion.div
                  whileTap={{ scale: 0.9 }}
        ...
        <div className="flex w-full sm: h-8 lg:h-10 mb-12 font-extralight bg-neutral-50 border-b sm: border-gray-200 lg:border-white">
          ...
          <div className="flex flex-col w-[20%] text-gray-800 font-sans">
            <div className="h-[80%] pl-3 py-1.5 sm: text-[12px] lg:text-[15px]">
              string
            </div>
            <div className="sm: pl-1 lg:pl-3 py-1.5 bg-gray-100 border-b sm: border-gray-300 lg:border-white sm: text-[13px] lg:text-[15px]">
              <span className="bg-black/85 text-white px-1.5 py-0.2 rounded-md">
                number
              </span>
            </div>
          </div>
